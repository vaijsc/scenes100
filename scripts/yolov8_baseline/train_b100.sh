...
#     --image_batch_size 28 \
#     --num_workers 4 \
#     --outputdir ./head/yolov8s_bs28_lr0.0001_teacherx2_conf0.4_b100_continue24k_interm_12_run8 \
#     --lr 1e-4 \
#     --split_list 12 \
...
CUDA_VISIBLE_DEVICES=$1 python inference_server_simulate_yolov8.py \
    ...
    --image_batch_size 28 \
    --num_workers 4 \
    --outputdir ./head/yolov8s_bs28_lr0.0001_teacherx2_conf0.4_b100_1stage_run12 \
    --lr 1e-4 \
