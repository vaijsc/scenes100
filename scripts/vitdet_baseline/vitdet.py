...
def load_vitdet(weight='vit_b_maskrcnn.pth'):
    ...
    backbone = SimpleFeaturePyramid(
        net=vit,
        in_feature=vit._out_features[0],
        out_channels=256,
    ...
    state_dict = torch.load('vit_b_maskrcnn.pth')
    ...
    del state_dict['roi_heads.mask_head.predictor.weight']
    del state_dict['roi_heads.mask_head.predictor.bias']
