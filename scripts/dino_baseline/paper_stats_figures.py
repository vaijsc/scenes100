...
def moe_ablation():
    ...
    iters = [24000, 32000]
    ylims = [41.8, 43.80]
    yticks = [42, 42.5, 43, 43.5, 44]
    plt.figure(figsize=figsize)
    plt.plot(iters, np.array([42.04, 43.04]), marker='o', ls='-', color='#000000', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.63]), marker='^', ls='-', color='#AA0000', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.36]), marker='D', ls='-', color='#0000AA', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 42.68]), marker='^', ls='--',color='#000077', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.10]), marker='D', ls='--',color='#004444', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    ...
    ylims = [40.8, 43.80]
    yticks = [41, 41.5, 42, 42.5, 43, 43.5, 44]
    plt.figure(figsize=figsize)
    plt.plot(iters, np.array([42.04, 43.04]), marker='o', ls='-', color='#000000', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.63]), marker='^', ls='-', color='#AA0000', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.36]), marker='D', ls='-', color='#0000AA', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([43.34, 42.21]), marker='^', ls='--',color='#000077', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([41.10, 42.29]), marker='D', ls='--',color='#004444', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    ...
    ylims = [39.5, 43.80]
    yticks = [39.5, 40, 40.5, 41, 41.5, 42, 42.5, 43, 43.5, 44]
    plt.figure(figsize=figsize)
    plt.plot(iters, np.array([42.04, 43.04]), marker='o', ls='-', color='#000000', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.63]), marker='^', ls='-', color='#AA0000', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([42.04, 43.29]), marker='^', ls='--',color='#000077', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([43.34, 42.21]), marker='^', ls=':',color='#442266', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
    plt.plot(iters, np.array([39.83, 41.55]), marker='^', ls='-.',color='#224455', lw=3, ms=9, markerfacecolor='none', markeredgewidth=2)
