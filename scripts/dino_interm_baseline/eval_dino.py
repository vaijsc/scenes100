...
def evaluate_individual_scenes100(args):
    ...
    for idx in video_id_list_copy:
        video_id_list = [idx]
        args.ckpt = os.path.join(os.path.dirname(__file__), "finetune_bs2_lr0.0001_teacherx1_conf0.3", idx, "adaptive_partial_server_detr_anno_allvideos_unlabeled_cocotrain.seq.cluster.budget1.iter.3999.pth")
