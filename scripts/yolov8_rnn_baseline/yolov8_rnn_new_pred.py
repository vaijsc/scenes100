...
from FastFlowNet.demo import find_flow_and_warp
...
class YOLORNN(DetectionModel):
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        ...
        for t in range(1, batch['img'].shape[0]): # t from 1 to B-1
            ...
            h_prev = self.h[-2] 
            warped_feats = [find_flow_and_warp(self.flow_model, batch['img'][t-1:t], batch['img'][t:t+1], enhanced_feats_prev[i]) for i in range(len(enhanced_feats_prev))]
