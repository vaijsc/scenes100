...
finetune_output = os.path.join(os.path.dirname(__file__), 'finetune_output_scaled_teacher_partial_output')


class GeneralizedRCNNPartialOutput(detectron2.modeling.meta_arch.rcnn.GeneralizedRCNN):
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        ...
        with torch.no_grad():
            ...
            features = {k: features[k].detach() for k in features}
    ...
    def create_from_sup(net):
        net.__class__ = GeneralizedRCNNPartialOutput
        return net
...
class FinetuneTrainer(DefaultTrainer):
    def __init__(self, cfg):
        ...
        print('only train output layers parameters: %d/%d %.4f%%' % (_count_train, _count_all, _count_train / _count_all * 100))
        model = GeneralizedRCNNPartialOutput.create_from_sup(model)
...
def teach_by_scaled(args):
    ...
    prefix = 'distill_%s_%s_anno_%s.partial.output' % (args.model, args.id, desc_pseudo_anno)
    print(prefix)
    results_0 = {}
...
'''
python finetune_scaled_teacher_partial_output.py --id 001 --opt distill --model r101-fpn-3x --anno_scales 2.0 --cocodir ../../../MSCOCO2017 --num_workers 1 --image_batch_size 2 --iters 450 --eval_interval 151 --train_on_coco 1
python finetune_scaled_teacher_partial_output.py --id 001 --opt distill --model r101-fpn-3x --anno_scales 2.0 --cocodir ../../../MSCOCO2017 --num_workers 4 --image_batch_size 4 --iters 16000 --eval_interval 1501 --train_on_coco 1

python finetune_scaled_teacher_partial_output.py --model r101-fpn-3x --opt eval --ckpt distill_r101-fpn-3x_001_anno_r101-fpn-3x_x2_cocotrain.pth
python finetune_scaled_teacher_partial_output.py --model r101-fpn-3x --opt eval --ckpts_dir cvpr24/distill_faster_rcnn_x2_teach
'''
