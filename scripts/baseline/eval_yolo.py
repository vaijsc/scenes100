...
def simulate(args):
    ...
    # model = load_yolov3(os.path.join(os.path.dirname(__file__),'../../configs/yolov3-custom.cfg'), os.path.join(os.path.dirname(__file__),'../../models/mscoco2017_remap_yolov3_416.pth'))
