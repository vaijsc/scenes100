...
finetune_output = os.path.join(os.path.dirname(__file__), 'finetune_output_wdiff_earlyfusion_mixup')

from finetune import refine_annotations, all_pseudo_annotations, get_annotation_dict, all_annotation_dict, finetune_simple_trainer_run_step
from finetune_wdiff_earlyfusion import all_pseudo_manual_annotations_with_background, construct_image_w_background, GeneralizedRCNNFinetuneBackground, FinetuneBackgroundTrainer
...
def adapt(args):
    ...
    desc_cocovalid, dst_cocovalid = 'mscoco2017_valid_remap_wdiff_earlyfusion_mixup', get_coco_dicts(_args, 'valid')
    ...
    if args.id in video_id_list:
        ...
        import functools
        args.id = '_compound'
        desc_manual_valid, desc_pseudo_anno = '%s_manual_wdiff_earlyfusion' % args.id, 'refine_' + '_'.join(args.anno_models)
...
python finetune_wdiff_earlyfusion_mixup.py --opt base --model r50-fpn-3x --cocodir ../../../MSCOCO2017 --iters 300 --eval_interval 160 --image_batch_size 2
python finetune_wdiff_earlyfusion_mixup.py --opt base --model r50-fpn-3x --cocodir ../../../MSCOCO2017 --iters 40000 --eval_interval 3000 --image_batch_size 4 --num_workers 4

python finetune_wdiff_earlyfusion_mixup.py --opt adapt --id 001 --model r50-fpn-3x --anno_models r50-fpn-3x r101-fpn-3x --ckpt ../../models/mscoco2017_remap_wdiff_earlyfusion_r50-fpn-3x.pth --train_on_coco 1 --cocodir ../../../MSCOCO2017 --iters 300 --eval_interval 400 --image_batch_size 2

python finetune_wdiff_earlyfusion_mixup.py --opt adapt --id 001 --model r50-fpn-3x --anno_models r50-fpn-3x r101-fpn-3x --ckpt ../../models/mscoco2017_remap_wdiff_earlyfusion_r50-fpn-3x.pth --train_on_coco 1 --cocodir ../../../MSCOCO2017 --iters 20000 --eval_interval 1800 --image_batch_size 4 --num_workers 4

python finetune_wdiff_earlyfusion_mixup.py --opt eval --id 001 --model r50-fpn-3x --ckpt adapt001_r50-fpn-3x_anno_refine_r101-fpn-3x_r50-fpn-3x_cocotrain_wdiff_earlyfusion.pth --cocodir ../../../MSCOCO2017 --eval_background last
python finetune_wdiff_earlyfusion_mixup.py --opt eval --id 001 --model r50-fpn-3x --ckpt adapt001_r50-fpn-3x_anno_refine_r101-fpn-3x_r50-fpn-3x_cocotrain_wdiff_earlyfusion.pth --eval_skip_coco 1 --eval_background dynamic

python finetune_wdiff_earlyfusion_mixup.py --opt compare --model r101-fpn-3x --compare_ckpt_dir E:\intersections_results\background_r101 --eval_background dynamic
