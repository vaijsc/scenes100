...
finetune_output = os.path.join(os.path.dirname(__file__), 'finetune_output_wdiff_latefusion')
...
class FinetuneBackgroundTrainer(DefaultTrainer):
    def __init__(self, cfg, multitask_loss_alpha):
        ...
        model = GeneralizedRCNNFinetuneBackground.create_from_sup(model, multitask_loss_alpha)
...
def train_base(args):
    ...
    desc_cocovalid, dst_cocovalid = 'mscoco2017_valid_remap_wdiff_latefusion', get_coco_dicts(_args, 'valid')
    desc_cocotrain, dst_cocotrain = 'mscoco2017_train_remap_wdiff_latefusion', get_coco_dicts(_args, 'train')
    ...
    trainer = FinetuneBackgroundTrainer(cfg, args.multitask_loss_alpha)
    ...
    prefix = 'mscoco2017_remap_wdiff_latefusion%s_%s' % ('' if args.coco_inpaint_type == 'mask' else '_boxinpaint', args.model)
...
def adapt(args):
    ...
    if args.id in video_id_list:
        ...
        desc_pseudo_anno = desc_pseudo_anno + '_wdiff_latefusion'
...
class PredictorBackground(DefaultPredictor):
    def __init__(self, cfg):
        ...
        self.model = GeneralizedRCNNFinetuneBackground.create_from_sup(self.model, None)
        self.model.eval()
...
def evaluate(args):
    ...
    if not args.eval_skip_coco:
        ...
        for im_i in tqdm.tqdm(range(0, len(detections[keys[0]])), ascii=True, desc='detecting MSCOCO2017 valid'):
            image, _, image_diff = read_images(detections[keys[0]][im_i]['file_name'], detections[keys[0]][im_i]['file_name_background'])
            instances = detector(image, image_diff)
            instances = {k: instances[k]['instances'].to('cpu') for k in instances}
            for k in instances:
...
python finetune_wdiff_latefusion.py --opt base --model r50-fpn-3x --cocodir ../../../MSCOCO2017 --iters 300 --eval_interval 160 --image_batch_size 2
python finetune_wdiff_latefusion.py --opt base --model r50-fpn-3x --cocodir ../../../MSCOCO2017 --iters 40000 --eval_interval 3000 --image_batch_size 4 --num_workers 4

python finetune_wdiff_latefusion.py --opt adapt --id 001 --model r50-fpn-3x --anno_models r50-fpn-3x r101-fpn-3x --ckpt ../../models/mscoco2017_remap_w_background_r50-fpn-3x.pth --train_on_coco 1 --cocodir ../../../MSCOCO2017 --iters 300 --eval_interval 160 --image_batch_size 2
python finetune_wdiff_latefusion.py --opt adapt --id 001 --model r50-fpn-3x --anno_models r50-fpn-3x r101-fpn-3x --ckpt ../../models/mscoco2017_remap_w_background_r50-fpn-3x.pth --train_on_coco 1 --cocodir ../../../MSCOCO2017 --iters 20000 --eval_interval 1800 --image_batch_size 4 --num_workers 4


python finetune_wdiff_latefusion.py --opt base --model r101-fpn-3x --coco_inpaint_type box --cocodir ../../../MSCOCO2017 --iters 40000 --eval_interval 3000 --image_batch_size 4 --num_workers 4
python finetune_wdiff_latefusion.py --opt adapt --id 001 --model r101-fpn-3x --coco_inpaint_type box --anno_models r50-fpn-3x r101-fpn-3x --ckpt mscoco2017_remap_wdiff_latefusion_boxinpaint_r101-fpn-3x.pth --train_on_coco 1 --cocodir ../../../MSCOCO2017 --iters 140 --eval_interval 80 --image_batch_size 2


python finetune_wdiff_latefusion.py --opt eval --id 001 --model r50-fpn-3x --ckpt adapt001_r50-fpn-3x_anno_refine_r101-fpn-3x_r50-fpn-3x_cocotrain_w_background.pth --cocodir ../../../MSCOCO2017 --eval_background last
python finetune_wdiff_latefusion.py --opt eval --id 001 --model r50-fpn-3x --ckpt adapt001_r50-fpn-3x_anno_refine_r101-fpn-3x_r50-fpn-3x_cocotrain_w_background.pth --eval_skip_coco 1 --eval_background dynamic

python finetune_wdiff_latefusion.py --opt compare --model r101-fpn-3x --compare_ckpt_dir E:\intersections_results\background_r101 --eval_background dynamic
