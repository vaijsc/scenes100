...
class DINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets:List=None, prompt=None):
        ...
        hs, reference, hs_enc, ref_enc, init_box_proposal = self.transformer(srcs, masks, input_query_bbox, poss, input_query_label, attn_mask, prompt)
