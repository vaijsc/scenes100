...
class AdaptativePartialTrainer(DefaultTrainer):
    def __init__(self, cfg, incremental_videos, ckpt):
        ...
        model.prompt = torch.nn.Parameter(torch.zeros(cfg.MODEL.DINO.NUM_PROMPTS, cfg.MODEL.DINO.HIDDEN_DIM).cuda())
        
        trainable_modules = [model.prompt] # TODO: edit for training prompt?
...
def adapt(args):
    ...
    cfg.MODEL.DINO.NUM_PROMPTS = args.num_prompt
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_prompt', type=int, default=10000)
